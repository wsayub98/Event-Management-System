...
<body class="align">
  ...
  <div class="grid">
    ...
    <form action="../controller/login_controller.php" method="POST" class="form login">
      ...
      <div class="form__field">
        <input type="text" name="name" class="form__input" placeholder="Nick Name" required>
      </div>
      ...
      <div class="form__field">
        <input hidden type="text" name="fx" value="0">
        <button style="background-color: #ea4c88;">Register</button>
      </div>
    </form>

    <div class="form login">
      <div class="form__field">
        <button onclick="window.location.assign('login.php')" style="margin-top:10px;">Back</button>
      </div>
    <div>
